...
During project creation, you will have the option to connect an image registry in **Amazon Elastic Container Registry (ECR)**, **Google Cloud Registry (GCR)**, **Google Artifact Registry (GAR)**, and **DigitalOcean Container Registry (DOCR)**. You can find instructions on [how to connect to each of these registries here](../deploying-applications/deploying-from-docker-registry/linking-existing-registry).

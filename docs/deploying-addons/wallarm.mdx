...
{
"type": "warning",
"title": "Put numbers in quotation marks",
"body": "Please ensure that your `nginx.ingress.kubernetes.io/wallarm-instance` value is surrounded with quotation marks. For example, if the number you'd like to assign to the instance is `101`, your value should be `\"101\"`"
}
[/block]

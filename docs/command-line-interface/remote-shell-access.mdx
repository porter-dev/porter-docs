...
- You're connected to the correct project by running [`porter config set-project`](./command-reference/porter-config)
- You're connected to the correct cluster by running [`porter config set-cluster`](./command-reference/porter-config)

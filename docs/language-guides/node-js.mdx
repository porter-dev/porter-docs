...
![Launch Tab 3](https://docs.porter.run/img/language-guides/node-js-launch-tab-3.png "Launch Tab - Choose git repository")

Click on the **main** branch, then click on **Continue**. You will be presented with a screen that looks like the following.

![Launch Tab 4](https://docs.porter.run/img/language-guides/node-js-launch-tab-4.png "Launch Tab - Deployment information")
...
![Applications Tab](https://docs.porter.run/img/language-guides/node-js-apps-view.png "Applications Tab - Newly created app")
...
![App URL](https://docs.porter.run/img/language-guides/node-js-app-url.png "Newly created app")

Once the app is successfully deployed, navigate to the URL as above and you should see something like the following.

![NodeJS App](https://docs.porter.run/img/language-guides/node-js-app.png "Successfully deployed NodeJS app")

...
import GARCLISection from "./_gar-cli-section.mdx";
import GARDashboardSection from "./_gar-dashboard-section.mdx";

<Tabs>
  <TabItem value="gar-dashboard" label="Browser" default>
    <GARDashboardSection />
  </TabItem>
  <TabItem value="gar-cli" label="CLI">
    <GARCLISection />
  </TabItem>
</Tabs>

...
To run a job as part of your application deployment process (for example, to run a migration script), see [this document](..//deploying-applications/deploying-from-github/customizing-github-workflow).
